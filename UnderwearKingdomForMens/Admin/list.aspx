...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" Text="Click here to add new product" OnClick="Button1_Click" />
    <asp:Button ID="Button2" runat="server" Text="Go to Admin homepage" OnClick="Button2_Click" />
